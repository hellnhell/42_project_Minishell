...
/*   Updated: 2020/12/09 17:28:09 by emartin-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define PROMPT "\e[91mM\e[92mI\e[93mN\e[94mI 🐚  \e[95m% \e[0m"
# define READ_END	0
# define WRITE_END	1
...
void				simbols_flags(t_tab *t, t_lista *lst, int doubl);
...
void				ft_cpy_newenv(char **env, char **newenv, char *var,
									char *val);
